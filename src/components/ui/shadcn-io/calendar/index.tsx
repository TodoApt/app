...
const CalendarContext = createContext<CalendarContextProps>({
  locale: "en-US",
  startDay: 0,
  minYear: subYears(new Date(), 1).getFullYear(),
  maxYear: addYears(new Date(), 1).getFullYear(),
});
...
export const CalendarYearPicker = ({
  ...
  const { minYear, maxYear } = useContext(CalendarContext);
  ...
  return (
    <div className={cn("flex items-center gap-2", className)}>
      ...
      <Button
        ...
        size="icon"
        variant="ghost"
        disabled={month === 11 && maxYear === year}
      >
...
export const CalendarProvider = ({
  ...
  <CalendarContext.Provider value={{ locale, startDay, minYear, maxYear }}>
